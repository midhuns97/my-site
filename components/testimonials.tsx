  ...
  const testimonials = [
    {
      ...
      content: "Alex transformed our software development process. The custom solution he built increased our team's productivity by 35% and significantly improved our product delivery timelines.",
    ...
    },
    {
      ...
      content: "The partnership strategy Alex developed for us opened doors to international markets we hadn't considered. Within a year, we established key alliances in 5 new countries.",
