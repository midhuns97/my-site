  ...
  return (
    <html lang="en" suppressHydrationWarning>
       <head>
        ...
        {/* ✅ Open Graph Meta */}
        <meta property="og:title" content="Midhun – Software Consultant & Tech Solution Architect in Dubai" />
        ...
        {/* ✅ Title Tag */}
        <title>Midhun – Software Consultant & Tech Solution Architect in Dubai</title>
